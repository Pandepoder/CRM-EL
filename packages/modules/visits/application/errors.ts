...
export function forbiddenError(code: string, message: string, publicMessage: string): ApplicationError {
  return new ApplicationError({ code, category: ErrorCategory.Forbidden, message, publicMessage });
}
