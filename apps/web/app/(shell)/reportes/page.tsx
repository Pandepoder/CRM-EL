            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="emergencia">🚨 Alerta de Seguridad (Emergencia)</option>
                  <option value="incidencia">⚠️ Incidencia Operativa</option>
                  <option value="mitin">👥 Mitin / Evento</option>
                  <option value="propaganda">📌 Colocación de Propaganda</option>
                  <option value="servicios">💡 Falla de Servicios</option>
